...
export default function ModalGetUsuario({
  visible,
  onClose,
  onConfirm,
  isLoadingUsuario,
}: ModalGetUsuarioProps) {
      ...
      <View className="flex-1 bg-slate-900/60 dark:bg-black/80 justify-center items-center p-6">
        ...
        <View className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-[32px] p-8 shadow-2xl overflow-hidden border border-slate-100 dark:border-slate-800">
          ...
          <View className="items-center mb-6">
            ...
            <Text className="text-slate-500 dark:text-slate-400 text-center mt-2 px-4 leading-5">
              Por favor ingrese su clave de seguridad para continuar.
            </Text>
          </View>
          ...
          >
            <View className="gap-6">
              <View>
                <Text className="text-[10px] font-bold text-slate-400 dark:text-slate-500 mb-2 ml-1 uppercase tracking-[2px]">
                  Clave de Seguridad
                </Text>
              ...
              <View className="flex-row gap-3 mt-4">
                <Pressable
                  onPress={onClose}
                  className="flex-1 bg-slate-100 dark:bg-slate-800 py-4 rounded-2xl active:bg-slate-200 dark:active:bg-slate-700 transition-colors"
                >
                ...
                <Pressable
                  ...
                  disabled={!clave}
                  className={`flex-[1.5] py-4 rounded-2xl active:opacity-90 shadow-md ${
                    clave
                      ? "bg-blue-600 dark:bg-blue-700 shadow-blue-500/30"
                      : "bg-slate-200 dark:bg-slate-700 opacity-50"
                  }`}
                >
                  <Text className="text-white font-bold text-center">
                    {isLoadingUsuario ? "Cargando..." : "Ingresar"}
                  </Text>
                </Pressable>
              </View>
            </View>
