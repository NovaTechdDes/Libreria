...
export const putMostrarPreciosConfig = async (valor: boolean): Promise<boolean> => {
  try {
    const { data } = await api.put('/api/configuracion/mostrar-precios', {
      id: 1,
      mostrar_precios: valor,
    });
