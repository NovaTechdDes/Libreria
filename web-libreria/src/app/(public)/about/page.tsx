    ...
    <main className="flex-1 bg-background transition-colors duration-300">
      ...
      <section className="relative min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 py-20">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-10 leading-relaxed max-w-2xl drop-shadow-sm font-light">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8 py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="bg-tertiary dark:bg-white/5 dark:backdrop-blur-xl dark:border dark:border-white/10 rounded-3xl p-10 md:p-16 relative overflow-hidden group shadow-sm">
            ...
            <div className="relative z-10">
              <div className="bg-white dark:bg-slate-800 p-3 rounded-xl shadow-sm inline-block mb-6">
                <BiBook className="size-8 text-primary" />
              </div>
              <h2 className="text-3xl font-bold text-secondary dark:text-primary mb-6">Misión</h2>
              <p className="text-lg text-neutral/80 dark:text-slate-300 leading-relaxed mb-10">
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  {['ana', 'juan', 'maria'].map((name) => (
                    <div key={name} className={`size-10 rounded-full border-2 border-white dark:border-slate-800 bg-neutral-200 dark:bg-slate-700 flex items-center justify-center text-[10px] text-neutral-500 font-bold overflow-hidden`}>
                      <div className="w-full h-full bg-primary/20 flex items-center justify-center uppercase">{name.charAt(0)}</div>
                    </div>
                  ))}
                </div>
                <span className="text-sm font-medium text-neutral dark:text-slate-400">+500 Familias confían en nosotros</span>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-8 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 bg-[#D1E1FF] dark:bg-secondary/20 dark:backdrop-blur-xl dark:border dark:border-white/5 rounded-3xl p-10 md:p-16 relative overflow-hidden group shadow-sm">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl font-bold text-secondary dark:text-[#4A90E2] mb-6">Visión</h2>
              <p className="text-lg text-secondary/80 dark:text-slate-300 leading-relaxed">
      ...
      <section id="servicios" className="bg-tertiary/50 py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-bold text-secondary dark:text-primary mb-4">Nuestros Sectores de Especialidad</h2>
            <p className="text-lg text-neutral/70 dark:text-slate-400">Dividimos nuestra experiencia para brindar soluciones precisas a cada necesidad, desde el entorno profesional hasta la etapa escolar.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Sector Comercial */}
            <div className="bg-white dark:bg-slate-900/50 dark:backdrop-blur-lg p-8 rounded-3xl shadow-sm border border-neutral-100 dark:border-white/5 hover:border-primary/30 transition-all group hover:shadow-xl hover:shadow-primary/5">
              ...
              <h3 className="text-xl font-bold text-secondary dark:text-white mb-4">Sector Comercial</h3>
              <p className="text-neutral/70 dark:text-slate-400 mb-8 leading-relaxed">Artículos y servicios especializados para oficinistas, profesionales y estudiantes universitarios que buscan eficiencia y calidad.</p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm font-medium text-secondary/80 dark:text-slate-300">Encuadernación profesional</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 bg-primary/10 rounded-full p-0.5">
                    <BiCheck className="text-primary font-bold" />
                  </div>
                  <span className="text-sm font-medium text-secondary/80 dark:text-slate-300">Material de oficina</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 bg-primary/10 rounded-full p-0.5">
                    <BiCheck className="text-primary font-bold" />
                  </div>
                  <span className="text-sm font-medium text-secondary/80 dark:text-slate-300">Elementos de facturacion</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900/50 dark:backdrop-blur-lg p-8 rounded-3xl shadow-sm border border-neutral-100 dark:border-white/5 hover:border-primary/30 transition-all group hover:shadow-xl hover:shadow-primary/5">
              ...
              <h3 className="text-xl font-bold text-secondary dark:text-white mb-4">Sector Escolar</h3>
              <p className="text-neutral/70 dark:text-slate-400 mb-8 leading-relaxed">Todo lo necesario para colegios, niños y adolescentes, fomentando el aprendizaje con los mejores materiales del mercado.</p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm font-medium text-secondary/80 dark:text-slate-300">Cuadernos y plasticos</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 bg-[#EDF2FF] rounded-full p-0.5">
                    <BiCheck className="text-[#4A90E2] font-bold" />
                  </div>
                  <span className="text-sm font-medium text-secondary/80 dark:text-slate-300">Utiles escolares</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 bg-[#EDF2FF] rounded-full p-0.5">
                    <BiCheck className="text-[#4A90E2] font-bold" />
                  </div>
                  <span className="text-sm font-medium text-secondary/80 dark:text-slate-300">Fotocopias y anillado</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900/50 dark:backdrop-blur-lg p-8 rounded-3xl shadow-sm border border-neutral-100 dark:border-white/5 hover:border-primary/30 transition-all group hover:shadow-xl hover:shadow-primary/5">
              ...
              <h3 className="text-xl font-bold text-secondary dark:text-white mb-4">Nuestros Valores</h3>
              <p className="text-neutral/70 dark:text-slate-400 mb-8 leading-relaxed">Nos definimos por ser comprometidos, honestos y fiables. Valores que han guiado nuestro crecimiento durante casi cuatro décadas.</p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm font-medium text-secondary/80 dark:text-slate-300">Atención personalizada</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="mt-1 bg-orange-50 rounded-full p-0.5">
                    <BiCheck className="text-orange-500 font-bold" />
                  </div>
                  <span className="text-sm font-medium text-secondary/80 dark:text-slate-300">Trayectoria garantizada</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Trust Bar */}
      <section className="bg-secondary dark:bg-black/40 dark:backdrop-blur-md border-t dark:border-white/5 py-10">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
