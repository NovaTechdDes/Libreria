...
export const FormularioColor = () => {
  ...
  return (
    <div className="bg-white p-8 rounded-4xl shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-slate-100 max-w-md w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <form className="space-y-7" onSubmit={handleAddColor}>
        ...
        <div className="flex flex-col gap-2.5">
          ...
          />
          {error && !nombre && <p className="text-red-500 text-xs animate-in fade-in slide-in-from-top-2 duration-300">El nombre es requerido</p>}
        </div>
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div className="flex gap-4">
            <div className="relative flex-1 group">
              ...
              />
              {error && !codigo && <p className="text-red-500 text-xs animate-in fade-in slide-in-from-top-2 duration-300">El codigo es requerido</p>}
            </div>
            <div className="relative group overflow-hidden rounded-2xl shadow-sm border border-slate-200">
              ...
              />
              <div className="w-16 h-full min-h-[56px] transition-transform duration-500 group-hover:scale-125" style={{ backgroundColor: `#${codigo.length === 6 ? codigo : 'eee'}` }}></div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-2">
          ...
          >
            <div
              className="w-16 h-16 rounded-3xl bg-white shadow-[0_10px_25px_rgba(0,0,0,0.08)] flex items-center justify-center transition-all duration-700 group-hover:rotate-360"
            ...
            <div className="absolute -right-4 -bottom-4 w-24 h-24 blur-3xl opacity-20 rounded-full" style={{ backgroundColor: `#${codigo.length === 6 ? codigo : '000'}` }}></div>
          </div>
        </div>
        ...
        {colorSeleccionado ? (
          <button
            type="submit"
            className="w-full bg-[#BFD7FF] hover:bg-[#A8C6FF] text-[#4A72B2] font-black py-5 rounded-2xl transition-all mt-4 shadow-[0_10px_20px_rgba(191,215,255,0.4)] active:scale-[0.98] text-base group"
          >
