    ...
    <article className="flex items-center p-6 gap-6 group">
      ...
      <div className="relative h-24 w-24 shrink-0">
        <Image
          ...
          fill
          className="rounded-xl object-cover shadow-sm border border-slate-100"
        />
      </div>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex flex-col">
          <h3 className="text-slate-900 text-lg font-bold truncate group-hover:text-teal-700 transition-colors">
            {producto.producto.descripcion}
          </h3>
          <p className="text-slate-400 text-xs font-bold uppercase tracking-wider mt-0.5">
            {producto.producto.id_rubro || "Librería"}
          </p>
