  ...
  return (
    <article className="flex items-center p-6 gap-6 group">
      ...
      <div className="relative h-24 w-24 shrink-0">
        {producto.producto.url_imagenes && producto.producto.url_imagenes.length > 0 ? (
          <Image src={producto.producto.url_imagenes[0].nombre_archivo} alt={producto.producto.descripcion} fill className="rounded-xl object-cover shadow-sm border border-slate-100" />
        ) : (
